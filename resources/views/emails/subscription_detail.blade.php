	...
	<tr>
		<td align="center" style="padding-bottom:100px; padding-top:70px">
            <table width="600" cellpadding="0" cellspacing="0" border="0">
				<tr>
                    <tr>
                        <td align=:"center" style="font-size:18px; text-align:center; font-weight:100; line-height:28px; font-style:italic; font-family:Georgia, 'Times New Roman', Times, serif;color:#757575; padding:15px 40px 20px;">{!! $emailText!!}</td>
                    </tr>
				</tr>
                <tr>
					<td align="center">
				...
				<tr>
					<td>
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#FFF">
							...
							<tr>
								<td align="center" style="color:#525252; font-size:16px; font-family:Verdana, Geneva, sans-serif; padding:20px 0 80px">{{trans('emails.emailWelcome_email_label')}} :  <a style="color:#1392de; text-decoration:none" > 
									{{$userDetail->email}}
								</a>
									<br>
									<br>
