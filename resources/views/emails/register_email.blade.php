				...
				<tr>
					<td>
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#FFF">
							...
							<tr>
								<td align=:"center" style="font-size:22px; text-align:center; font-weight:800; line-height:24px; font-family:Verdana, Geneva, sans-serif;color:#757575; padding:20px 40px 15px;">
									{{trans('emails.emailWelcome_thanks')}}
								</td>
							</tr>
							@if(!empty($registerMessage))
							<tr>
								<td align=:"center" style="font-size:18px; text-align:center; font-weight:100; line-height:28px; font-style:italic; font-family:Georgia, 'Times New Roman', Times, serif;color:#757575; padding:15px 40px 20px;">{!! $registerMessage !!}</td>
							</tr>
							@endif
							<tr>
                            ...
                            <tr>
								<td align=:"center" style="font-size:22px; text-align:center; font-weight:100; line-height:28px; font-style:italic; font-family:Georgia, 'Times New Roman', Times, serif;color:#757575; padding:15px 40px 20px;">{{trans('emails.emailRegister_contactDetail_msg')}} :</td>
							</tr>
                            <tr>
                                <td align="center" style="color:#525252; font-size:16px;font-family:Georgia, 'Times New Roman', Times, serif;color:#757575; padding:15px 40px 20px;">
                                        {{trans('emails.emailWelcome_email_label')}}:
                                    <a style="color:#1392de; text-decoration:none"> 
                                        {{$userEmail}}
                                    </a>
                                    <br>
                                        {{trans('emails.emailWelcome_password')}}: 
                                    <a style="color:#1392de; text-decoration:none"> 
                                        {{$password}}
                                    </a>
                                </td>
									...
									<table cellpadding="0" cellspacing="0" border="0" width="295">
										<tr>
											<td align="center" height="53" bgcolor="#1392de" style="border-radius: 5px; color: #ffffff; display: block;">
                                                <a href="{{url(SITE_LANG.'/login')}}" style=" text-transform:uppercase;font-size:15px; font-weight: bold; font-family:Arial, sans-serif; text-decoration: none; line-height:52px; width:100%; display:block">
                                                    <span style="color: #ffffff">{{trans('emails.visitMiparo')}}</span>
                                                </a>
                                            </td>
										</tr>
									</table>
