	...
	<tr>
		<td align="center" style="padding-bottom:100px; padding-top:70px">
            <table width="600" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td align="center" style="padding:30px 0 50px;font-family:Georgia, 'Times New Roman', Times, serif; font-size:75px; color:#1392de;font-style:italic;">
						{{trans('emails.emailWelcome_welcome')}}
					</td>
				</tr>
                <tr>
					<td align="center">
						<img src="{{url('/assets/img/bg.png')}}" alt="..." style="display:block; border:0;">
					</td>
				</tr>
				<tr>
					<td>
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#FFF">
							<tr>
								<td align=:"center" style="padding:20px 0; text-align:center;font-family:Georgia, 'Times New Roman', Times, serif; font-size:30px; color:#1392de;font-style:italic;"> {{trans('emails.NewAgentAccount')}} </td>
							</tr>
							@if(!empty($agentPermissionsMessage))
								<tr>
									<td align=:"center" style="font-size:18px; text-align:center; font-weight:100; line-height:28px; font-style:italic; font-family:Georgia, 'Times New Roman', Times, serif;color:#757575; padding:15px 40px 20px;">{{$agentPermissionsMessage}}</td>
								</tr>
							@endif
							<tr>
							...
							<tr>
								<td align="center" style="color:#525252; font-size:16px; font-family:Verdana, Geneva, sans-serif; padding:20px 0 80px">{{trans('emails.emailWelcome_email_label')}} :  <a style="color:#1392de; text-decoration:none" > {{$userDetail->email}}</a>
									@if(!empty($password))
										<br>{{trans('emails.emailWelcome_password')}} :  <a style="color:#1392de; text-decoration:none" > {{$password}}</a>
									@endif
									<br>
									<br>
									<br>
